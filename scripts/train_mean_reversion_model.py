"""Train a research-only mean_reversion opportunity model from a KIW-14 dataset."""
...
from kiwit.ml.mean_reversion import MeanReversionConfig, train_mean_reversion


def main():
    parser = argparse.ArgumentParser(description=__doc__)
    parser.add_argument("--dataset", type=Path, required=True)
    parser.add_argument("--output", type=Path, default=ROOT / "data/local/mean_reversion-models")
